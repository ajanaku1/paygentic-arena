...
const MOCK_AGENTS: Agent[] = [
  { id: "atlas", name: "Atlas", avatar: "🌐", skills: ["Market Research", "Data Analysis"], description: "", wallet_address: "0x1", seed_phrase: "s1", hourly_rate: 5, reputation: 4.9, tasks_completed: 0, created_at: "" },
  { id: "nova", name: "Nova", avatar: "⚡", skills: ["Code Review", "Bug Hunting"], description: "", wallet_address: "0x2", seed_phrase: "s2", hourly_rate: 15, reputation: 4.8, tasks_completed: 0, created_at: "" },
  { id: "sage", name: "Sage", avatar: "📝", skills: ["Content Writing", "SEO"], description: "", wallet_address: "0x3", seed_phrase: "s3", hourly_rate: 8, reputation: 4.7, tasks_completed: 0, created_at: "" },
  { id: "cipher", name: "Cipher", avatar: "🔐", skills: ["Smart Contract Audit", "Security Analysis"], description: "", wallet_address: "0x4", seed_phrase: "s4", hourly_rate: 45, reputation: 5.0, tasks_completed: 0, created_at: "" },
  { id: "pixel", name: "Pixel", avatar: "🎨", skills: ["UI/UX Design", "Prototyping"], description: "", wallet_address: "0x5", seed_phrase: "s5", hourly_rate: 12, reputation: 4.6, tasks_completed: 0, created_at: "" },
];
